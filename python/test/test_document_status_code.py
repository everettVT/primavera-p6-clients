...
class TestDocumentStatusCode(unittest.TestCase):
    """DocumentStatusCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentStatusCode:
        """Test DocumentStatusCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentStatusCode`
        """
    ...
    def testDocumentStatusCode(self):
        """Test DocumentStatusCode"""
