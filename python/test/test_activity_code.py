...
class TestActivityCode(unittest.TestCase):
    """ActivityCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCode:
        """Test ActivityCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCode`
        """
        model = ActivityCode()
        if include_optional:
            return ActivityCode(
