...
class TestReadWBSRoleSpreadResponse(unittest.TestCase):
    """ReadWBSRoleSpreadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadWBSRoleSpreadResponse:
        """Test ReadWBSRoleSpreadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadWBSRoleSpreadResponse`
        """
        model = ReadWBSRoleSpreadResponse()
        if include_optional:
            return ReadWBSRoleSpreadResponse(
                wbs_code = '',
                wbs_object_id = 56,
                role_id = '',
                role_object_id = 56,
    ...
    def testReadWBSRoleSpreadResponse(self):
        """Test ReadWBSRoleSpreadResponse"""
