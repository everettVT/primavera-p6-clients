...
class TestCostAccount(unittest.TestCase):
    """CostAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CostAccount:
        """Test CostAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CostAccount`
        """
        model = CostAccount()
        if include_optional:
            return CostAccount(
