...
class TestEPSNote(unittest.TestCase):
    """EPSNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EPSNote:
        """Test EPSNote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EPSNote`
        """
        model = EPSNote()
        if include_optional:
            return EPSNote(
