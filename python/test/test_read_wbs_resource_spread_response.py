...
class TestReadWBSResourceSpreadResponse(unittest.TestCase):
    """ReadWBSResourceSpreadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadWBSResourceSpreadResponse:
        """Test ReadWBSResourceSpreadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadWBSResourceSpreadResponse`
        """
        model = ReadWBSResourceSpreadResponse()
        if include_optional:
            return ReadWBSResourceSpreadResponse(
                wbs_code = '',
                wbs_object_id = 56,
                resource_id = '',
    ...
    def testReadWBSResourceSpreadResponse(self):
        """Test ReadWBSResourceSpreadResponse"""
