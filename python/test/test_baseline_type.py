...
class TestBaselineType(unittest.TestCase):
    """BaselineType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaselineType:
        """Test BaselineType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaselineType`
        """
        model = BaselineType()
        if include_optional:
            return BaselineType(
