...
class TestActivityOwner(unittest.TestCase):
    """ActivityOwner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityOwner:
        """Test ActivityOwner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityOwner`
        """
        model = ActivityOwner()
        if include_optional:
