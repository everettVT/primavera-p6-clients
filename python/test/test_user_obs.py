...
class TestUserOBS(unittest.TestCase):
    """UserOBS unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserOBS:
        """Test UserOBS
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserOBS`
        """
        model = UserOBS()
        if include_optional:
            return UserOBS(
