...
class TestRiskMatrix(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RiskMatrix:
        """Test RiskMatrix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RiskMatrix`
        """
        model = RiskMatrix()
        if include_optional:
            return RiskMatrix(
