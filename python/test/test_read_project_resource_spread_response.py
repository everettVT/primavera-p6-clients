...
class TestReadProjectResourceSpreadResponse(unittest.TestCase):
    """ReadProjectResourceSpreadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReadProjectResourceSpreadResponse:
        """Test ReadProjectResourceSpreadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReadProjectResourceSpreadResponse`
        """
        model = ReadProjectResourceSpreadResponse()
        if include_optional:
            return ReadProjectResourceSpreadResponse(
                project_id = '',
    ...
    def testReadProjectResourceSpreadResponse(self):
        """Test ReadProjectResourceSpreadResponse"""
