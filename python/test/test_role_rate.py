...
class TestRoleRate(unittest.TestCase):
    """RoleRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoleRate:
        """Test RoleRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoleRate`
        """
        model = RoleRate()
        if include_optional:
            return RoleRate(
