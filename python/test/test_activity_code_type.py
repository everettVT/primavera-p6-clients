...
class TestActivityCodeType(unittest.TestCase):
    """ActivityCodeType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCodeType:
        """Test ActivityCodeType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCodeType`
        """
        model = ActivityCodeType()
        if include_optional:
