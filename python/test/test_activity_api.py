...
class TestActivityApi(unittest.TestCase):
    ...
    def test_get_activity_field_length(self) -> None:
        """Test case for get_activity_field_length

        View Activity Field Length
        """
        pass

    def test_get_activity_fields(self) -> None:
        """Test case for get_activity_fields
