...
class TestHolidayOrExceptions(unittest.TestCase):
    """HolidayOrExceptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HolidayOrExceptions:
        """Test HolidayOrExceptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HolidayOrExceptions`
        """
        model = HolidayOrExceptions()
        if include_optional:
    ...
    def testHolidayOrExceptions(self):
        """Test HolidayOrExceptions"""
