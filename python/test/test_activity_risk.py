...
class TestActivityRisk(unittest.TestCase):
    """ActivityRisk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityRisk:
        """Test ActivityRisk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityRisk`
        """
        model = ActivityRisk()
        if include_optional:
            return ActivityRisk(
