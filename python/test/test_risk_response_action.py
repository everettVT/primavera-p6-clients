...
class TestRiskResponseAction(unittest.TestCase):
    """RiskResponseAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RiskResponseAction:
        """Test RiskResponseAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RiskResponseAction`
        """
        ...
        if include_optional:
            return RiskResponseAction(
                ...
                risk_response_plan_object_id = 56,
                score = 56,
                score_color = '',
                score_text = '',
    ...
    def testRiskResponseAction(self):
        """Test RiskResponseAction"""
