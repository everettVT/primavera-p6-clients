...
class TestCurrencyApi(unittest.TestCase):
    ...
    def test_get_currency_field_length(self) -> None:
        """Test case for get_currency_field_length

        View Currency Field Length
        """
        pass

    def test_get_currency_fields(self) -> None:
        """Test case for get_currency_fields
