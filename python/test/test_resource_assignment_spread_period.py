...
class TestResourceAssignmentSpreadPeriod(unittest.TestCase):
    """ResourceAssignmentSpreadPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceAssignmentSpreadPeriod:
        """Test ResourceAssignmentSpreadPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceAssignmentSpreadPeriod`
        """
        model = ResourceAssignmentSpreadPeriod()
        if include_optional:
            return ResourceAssignmentSpreadPeriod(
                start_date = '',
                end_date = '',
                actual_cost = 1.337,
    ...
    def testResourceAssignmentSpreadPeriod(self):
        """Test ResourceAssignmentSpreadPeriod"""
