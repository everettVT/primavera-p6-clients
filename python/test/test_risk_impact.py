...
class TestRiskImpact(unittest.TestCase):
    """RiskImpact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RiskImpact:
        """Test RiskImpact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RiskImpact`
        """
        model = RiskImpact()
        if include_optional:
            return RiskImpact(
