...
class RoleApi:
    ...
    def create_role(
        self,
        role: Annotated[List[Role], Field(description="A list of Role objects.")],
        ...
        :param role: A list of Role objects. (required)
        :type role: List[Role]
    ...
    def delete_role(
        self,
        object_id: Annotated[StrictStr, Field(description="One or more system-generated identifiers of Role.")],
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param object_id: One or more system-generated identifiers of Role. (required)
        :type object_id: str
        :param authorization: OAuth token
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    @validate_call
    def get_role_field_length(
        self,
        field_name: Annotated[StrictStr, Field(description="A Role field.")],
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param field_name: A Role field. (required)
        :type field_name: str
        :param authorization: OAuth token
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._get_role_field_length_serialize(
    ...
    @validate_call
    def get_role_field_length_with_http_info(
        self,
        field_name: Annotated[StrictStr, Field(description="A Role field.")],
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_role_field_length_without_preload_content(
        self,
        field_name: Annotated[StrictStr, Field(description="A Role field.")],
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        _request_timeout: Union[
    ...
    def _get_role_field_length_serialize(
        self,
        field_name,
        authorization,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role/getFieldLength/{fieldName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_role_fields(
        ...
        _param = self._get_role_fields_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_role_fields_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_role_fields_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_role_fields_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
