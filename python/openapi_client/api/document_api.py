...
class DocumentApi:
    ...
    def create_document(
        self,
        document: Annotated[List[Document], Field(description="A list of document objects.")],
        ...
        :param document: A list of document objects. (required)
    ...
    def delete_document(
        self,
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        object_id: Annotated[Optional[StrictStr], Field(description="One or more system-generated identifiers of document.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param authorization: OAuth token
        :type authorization: str
        :param object_id: One or more system-generated identifiers of document.
        :type object_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    @validate_call
    def get_document_field_length(
        self,
        field_name: Annotated[StrictStr, Field(description="An document field.")],
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param field_name: An document field. (required)
        :type field_name: str
        :param authorization: OAuth token
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._get_document_field_length_serialize(
    ...
    @validate_call
    def get_document_field_length_with_http_info(
        self,
        field_name: Annotated[StrictStr, Field(description="An document field.")],
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_document_field_length_without_preload_content(
        self,
        field_name: Annotated[StrictStr, Field(description="An document field.")],
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        _request_timeout: Union[
    ...
    def _get_document_field_length_serialize(
        self,
        field_name,
        authorization,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/document/getFieldLength/{fieldName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_document_fields(
        ...
        _param = self._get_document_fields_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_document_fields_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_document_fields_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_document_fields_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
