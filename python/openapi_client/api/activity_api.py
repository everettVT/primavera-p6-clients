...
class ActivityApi:
    ...
    def create_activity(
        self,
        activity: Annotated[List[Activity], Field(description="A list of activity objects.")],
        ...
        :param activity: A list of activity objects. (required)
        :type activity: List[Activity]
    ...
    def delete_activity(
        self,
        object_id: Annotated[StrictStr, Field(description="One or more system-generated identifiers of activity.")],
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param object_id: One or more system-generated identifiers of activity. (required)
        :type object_id: str
        :param authorization: OAuth token
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    @validate_call
    def get_activity_field_length(
        self,
        field_name: Annotated[StrictStr, Field(description="An activity field.")],
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param field_name: An activity field. (required)
        :type field_name: str
        :param authorization: OAuth token
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._get_activity_field_length_serialize(
    ...
    @validate_call
    def get_activity_field_length_with_http_info(
        self,
        field_name: Annotated[StrictStr, Field(description="An activity field.")],
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_activity_field_length_without_preload_content(
        self,
        field_name: Annotated[StrictStr, Field(description="An activity field.")],
        authorization: Annotated[Optional[StrictStr], Field(description="OAuth token")] = None,
        _request_timeout: Union[
    ...
    def _get_activity_field_length_serialize(
        self,
        field_name,
        authorization,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/activity/getFieldLength/{fieldName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_activity_fields(
        ...
        _param = self._get_activity_fields_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_activity_fields_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_activity_fields_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_activity_fields_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
