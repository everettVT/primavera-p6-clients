...
class CreateActivityCodeAssignmentsResponse(BaseModel):
    """
    ...
    activity_object_id: Optional[StrictInt] = Field(default=None, description="The unique ID of the activity to which the activity code is assigned.", alias="ActivityObjectId")
    __properties: ClassVar[List[str]] = ["ActivityCodeTypeObjectId", "ActivityObjectId"]
