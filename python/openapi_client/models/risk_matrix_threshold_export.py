...
class RiskMatrixThresholdExport(BaseModel):
    """
    ...
    var_field: Optional[List[StrictStr]] = Field(default=None, description="List of Fields for RiskMatrixThreshold Business Object", alias="Field")
    ...
    def var_field_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['CREATE_DATE', 'CREATE_USER', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'RISK_MATRIX_NAME', 'RISK_MATRIX_OBJECT_ID', 'RISK_THRESHOLD_NAME', 'RISK_THRESHOLD_OBJECT_ID']):
                raise ValueError("each list item must be one of ('CREATE_DATE', 'CREATE_USER', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'RISK_MATRIX_NAME', 'RISK_MATRIX_OBJECT_ID', 'RISK_THRESHOLD_NAME', 'RISK_THRESHOLD_OBJECT_ID')")
        return value
