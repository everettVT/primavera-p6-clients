...
class UpdateBaseline(BaseModel):
    ...
    """ # noqa: E501
    object_id: Optional[StrictInt] = Field(default=None, description="The unique identifier for the job.", alias="ObjectId")
    baseline_proj_id: Optional[StrictInt] = Field(default=None, description="The unique identifier for the baseline project.", alias="BaselineProjId")
    ...
    __properties: ClassVar[List[str]] = ["ObjectId", "BaselineProjId", "Timeout"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "BaselineProjId": obj.get("BaselineProjId"),
