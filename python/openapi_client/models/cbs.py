...
class CBS(BaseModel):
    ...
    CBS Entity
    """ # noqa: E501
    cbs_code: StrictStr = Field(description="The unique name of the Unifier CBS Code. Assign CBS codes to activities so that you can filter which activities you will send to Unifier.", alias="CBSCode")
    cbs_description: Optional[StrictStr] = Field(default=None, description="The description of the associated CBS.", alias="CBSDescription")
    cbs_status: Optional[StrictStr] = Field(default=None, description="Specifies the status of the CBS.", alias="CBSStatus")
    ...
    parent_object_id: Optional[StrictInt] = Field(default=None, description="The unique ID of the parent CBS for this CBS in the hierarchy.", alias="ParentObjectId")
    project_object_id: StrictInt = Field(description="The unique ID of the associated project.", alias="ProjectObjectId")
    __properties: ClassVar[List[str]] = ["CBSCode", "CBSDescription", "CBSStatus", "CreateDate", "CreateUser", "LastUpdateDate", "LastUpdateUser", "ObjectId", "ParentObjectId", "ProjectObjectId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "CBSDescription": obj.get("CBSDescription"),
            "CBSStatus": obj.get("CBSStatus"),
