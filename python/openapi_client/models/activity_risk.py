...
class ActivityRisk(BaseModel):
    ...
    activity_object_id: StrictInt = Field(description="The unique ID of the activity to which the risk is assigned.", alias="ActivityObjectId")
    create_date: Optional[datetime] = Field(default=None, description="The date this activity was created.", alias="CreateDate")
    create_user: Optional[StrictStr] = Field(default=None, description="The name of the user that created this activity risk.", alias="CreateUser")
    ...
    last_update_user: Optional[StrictStr] = Field(default=None, description="The name of the user that last updated this activity risk.", alias="LastUpdateUser")
    ...
    __properties: ClassVar[List[str]] = ["ActivityId", "ActivityName", "ActivityObjectId", "CreateDate", "CreateUser", "IsBaseline", "IsTemplate", "LastUpdateDate", "LastUpdateUser", "ProjectId", "ProjectName", "ProjectObjectId", "RiskId", "RiskName", "RiskObjectId"]
