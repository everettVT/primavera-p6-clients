...
class CreateUserOBSResponse(BaseModel):
    """
    ...
    obs_object_id: Optional[StrictInt] = Field(default=None, description="The unique ID of the associated OBS.", alias="OBSObjectId")
    __properties: ClassVar[List[str]] = ["UserObjectId", "OBSObjectId"]
