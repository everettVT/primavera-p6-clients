...
class ActivityOwner(BaseModel):
    ...
    create_date: Optional[datetime] = Field(default=None, description="The date this activity owner was created.", alias="CreateDate")
    create_user: Optional[StrictStr] = Field(default=None, description="The name of the user that created this activity owner.", alias="CreateUser")
    is_activity_flagged: Optional[StrictBool] = Field(default=None, description="The flag that indicates whether the owner of the activity has flagged the activity as important.", alias="IsActivityFlagged")
    ...
    last_update_date: Optional[datetime] = Field(default=None, description="The date this activity owner was last updated.", alias="LastUpdateDate")
    last_update_user: Optional[StrictStr] = Field(default=None, description="The name of the user that last updated this activity owner.", alias="LastUpdateUser")
    ...
    project_project_flag: Optional[StrictStr] = Field(default=None, description="Indicates if this Project/EPS node is a Project or EPS.", alias="ProjectProjectFlag")
    ...
    user_object_id: StrictInt = Field(description="The unique ID of the associated user.", alias="UserObjectId")
    __properties: ClassVar[List[str]] = ["ActivityObjectId", "CreateDate", "CreateUser", "IsActivityFlagged", "IsBaseline", "IsTemplate", "LastUpdateDate", "LastUpdateUser", "ProjectFlag", "ProjectObjectId", "ProjectProjectFlag", "StatusCode", "UserObjectId"]
