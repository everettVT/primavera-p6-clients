...
class SummarizeProject(BaseModel):
    """
    SummarizeProject Entity
    """ # noqa: E501
    object_id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the project you want to summarize.", alias="ObjectId")
    ...
    __properties: ClassVar[List[str]] = ["ObjectId", "Timeout"]
