...
class ProjectResourceCategoryExport(BaseModel):
    """
    ...
    var_field: Optional[List[StrictStr]] = Field(default=None, description="List of Fields for ProjectResourceCategory Business Object", alias="Field")
