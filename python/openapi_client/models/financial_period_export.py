...
class FinancialPeriodExport(BaseModel):
    """
    ...
    var_field: Optional[List[StrictStr]] = Field(default=None, description="List of Fields for FinancialPeriod Business Object", alias="Field")
    ...
    def var_field_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['CREATE_DATE', 'CREATE_USER', 'END_DATE', 'FINANCIAL_PERIOD_TEMPLATE_ID', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'NAME', 'OBJECT_ID', 'START_DATE']):
                raise ValueError("each list item must be one of ('CREATE_DATE', 'CREATE_USER', 'END_DATE', 'FINANCIAL_PERIOD_TEMPLATE_ID', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'NAME', 'OBJECT_ID', 'START_DATE')")
        return value
