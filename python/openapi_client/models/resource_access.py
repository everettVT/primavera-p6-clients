...
class ResourceAccess(BaseModel):
    ...
    """ # noqa: E501
    create_date: Optional[datetime] = Field(default=None, description="The date this resource security was created.", alias="CreateDate")
    create_user: Optional[StrictStr] = Field(default=None, description="The name of the user that created this resource security.", alias="CreateUser")
    last_update_date: Optional[datetime] = Field(default=None, description="The date this resource security was last updated.", alias="LastUpdateDate")
    last_update_user: Optional[StrictStr] = Field(default=None, description="The name of the user that last updated this resource security.", alias="LastUpdateUser")
    ...
    __properties: ClassVar[List[str]] = ["CreateDate", "CreateUser", "LastUpdateDate", "LastUpdateUser", "ResourceId", "ResourceName", "ResourceObjectId", "SequenceNumber", "UserName", "UserObjectId"]
