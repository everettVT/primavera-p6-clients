...
class ReadProjectResourceSpreadResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ProjectId", "ProjectObjectId", "ResourceId", "ResourceObjectId", "StartDate", "EndDate", "PeriodType", "Period"]
