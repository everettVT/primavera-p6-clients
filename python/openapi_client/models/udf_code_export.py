...
class UDFCodeExport(BaseModel):
    ...
    var_field: Optional[List[StrictStr]] = Field(default=None, description="List of Fields for UDFCode Business Object", alias="Field")
    ...
    def var_field_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['CODE_TYPE_OBJECT_ID', 'CODE_TYPE_TITLE', 'CODE_VALUE', 'CREATE_DATE', 'CREATE_USER', 'DESCRIPTION', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'OBJECT_ID', 'SEQUENCE_NUMBER']):
                raise ValueError("each list item must be one of ('CODE_TYPE_OBJECT_ID', 'CODE_TYPE_TITLE', 'CODE_VALUE', 'CREATE_DATE', 'CREATE_USER', 'DESCRIPTION', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'OBJECT_ID', 'SEQUENCE_NUMBER')")
        return value
