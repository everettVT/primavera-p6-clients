...
class WBSCategoryExport(BaseModel):
    """
    WBSCategory Entity
    """ # noqa: E501
    ...
    var_field: Optional[List[StrictStr]] = Field(default=None, description="List of Fields for WBSCategory Business Object", alias="Field")
