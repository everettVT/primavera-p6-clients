...
class SummarizeEPS(BaseModel):
    """
    SummarizeProject Entity
    """ # noqa: E501
    object_id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the EPS you want to summarize.", alias="ObjectId")
