...
class EPS(BaseModel):
    ...
    EPS Entity
    """ # noqa: E501
    anticipated_finish_date: Optional[datetime] = Field(default=None, description="The anticipated finish date of the EPS. User-entered - not dependent upon any other fields. If there are no children, the anticipated finish date will be the finish date displayed in the columns.", alias="AnticipatedFinishDate")
    anticipated_start_date: Optional[datetime] = Field(default=None, description="The anticipated start date of the EPS. User-entered - not dependent upon any other fields. If there are no children, the anticipated start date will be the start date displayed in the columns.", alias="AnticipatedStartDate")
    create_date: Optional[datetime] = Field(default=None, description="The date this EPS was created.", alias="CreateDate")
    create_user: Optional[StrictStr] = Field(default=None, description="The name of the user that created this EPS.", alias="CreateUser")
    ...
    finish_date: Optional[datetime] = Field(default=None, description="The finish date of the EPS.", alias="FinishDate")
    guid: Optional[StrictStr] = Field(default=None, description="The globally unique ID generated by the system.", alias="GUID")
    id: StrictStr = Field(description="The short code assigned to each EPS element for identification.", alias="Id")
    ...
    last_update_date: Optional[datetime] = Field(default=None, description="The date this EPS was last updated.", alias="LastUpdateDate")
    last_update_user: Optional[StrictStr] = Field(default=None, description="The name of the user that last updated this EPS.", alias="LastUpdateUser")
    name: StrictStr = Field(description="The name of the EPS element.", alias="Name")
    ...
    obs_object_id: StrictInt = Field(description="The unique ID of the project manager from the project's OBS tree who is responsible for the EPS.", alias="OBSObjectId")
    ...
    parent_object_id: StrictInt = Field(description="The unique ID of the parent EPS of this EPS in the hierarchy.", alias="ParentObjectId")
    ...
    project_object_id: Optional[StrictInt] = Field(default=None, description="The internal Project ID of the EPS. This ID cannot be used to load a Project object directly.", alias="ProjectObjectId")
    ...
    start_date: Optional[datetime] = Field(default=None, description="The start date of the EPS.", alias="StartDate")
    summary_accounting_variance_by_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Ttual Cost. A negative value indicates that the Actual Cost has exceeded the Planned Value.", alias="SummaryAccountingVarianceByCost")
    ...
    summary_actual_expense_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The actual costs for all project expenses associated with the EPS.", alias="SummaryActualExpenseCost")
    summary_actual_finish_date: Optional[datetime] = Field(default=None, description="The latest actual finish date of all activities in the EPS.", alias="SummaryActualFinishDate")
    ...
    summary_actual_start_date: Optional[datetime] = Field(default=None, description="The earliest actual start date of all activities in the EPS.", alias="SummaryActualStartDate")
    ...
    summary_baseline_finish_date: Optional[datetime] = Field(default=None, description="The current latest finish date of all activities in the EPS for the current baseline.", alias="SummaryBaselineFinishDate")
    ...
    summary_baseline_start_date: Optional[datetime] = Field(default=None, description="The current earliest start date of all activities in the EPS for the current baseline.", alias="SummaryBaselineStartDate")
    ...
    summary_completed_activity_count: Optional[StrictInt] = Field(default=None, description="The number of activities that have an Actual Finish in the EPS.", alias="SummaryCompletedActivityCount")
    summary_cost_percent_complete: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The percent complete of costs for the resource assignments in the EPS. Computed as Actual Units / At Complete Units * 100. Always in the range 0 to 100.", alias="SummaryCostPercentComplete")
    ...
    summary_duration_percent_of_planned: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The summary actual duration percent of planned of all activities under this EPS. Computed as actual duration / baseline duration * 100. The value can exceed 100. The Baseline duration is the activity's at complete duration from the current baseline.", alias="SummaryDurationPercentOfPlanned")
    ...
    summary_earned_value_by_labor_units: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The Schedule Variance Labor Units divided by the Planned Value Labor Units.", alias="SummaryEarnedValueByLaborUnits")
    ...
    summary_labor_cost_percent_complete: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The percent complete of cost for all labor resources assigned to the EPS. It is computed as Actual Labor Cost / At Complete Labor Cost * 100, and it is always in the range of 0 to 100.", alias="SummaryLaborCostPercentComplete")
    ...
    summary_labor_units_percent_complete: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The percent complete of units for all labor resources for the EPS. Computed as actual labor units / at complete labor units * 100. Always in the range 0 to 100.", alias="SummaryLaborUnitsPercentComplete")
    ...
    summary_material_cost_percent_complete: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The percent complete of cost for all material resources assigned to the EPS. It is computed as Actual Material Cost / At Complete Material Cost * 100, and it is always in the range of 0 to 100.", alias="SummaryMaterialCostPercentComplete")
    ...
    summary_planned_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The sum of all planned expense, non labor, labor, and material costs in the EPS.", alias="SummaryPlannedCost")
    summary_planned_duration: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total working days between planned start and finish dates in the EPS.", alias="SummaryPlannedDuration")
    summary_planned_expense_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The sum of all planned expense costs in the EPS.", alias="SummaryPlannedExpenseCost")
    summary_planned_finish_date: Optional[datetime] = Field(default=None, description="The latest planned finish date of all activities in the EPS.", alias="SummaryPlannedFinishDate")
    summary_planned_labor_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The sum of all planned labor costs in the EPS.", alias="SummaryPlannedLaborCost")
    summary_planned_labor_units: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The sum of all planned labor units in the EPS.", alias="SummaryPlannedLaborUnits")
    summary_planned_material_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The sum of all planned material costs in the EPS.", alias="SummaryPlannedMaterialCost")
    summary_planned_non_labor_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The sum of all planned non labor costs in the EPS.", alias="SummaryPlannedNonLaborCost")
    summary_planned_non_labor_units: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The sum of all planned non labor units in the EPS.", alias="SummaryPlannedNonLaborUnits")
    summary_planned_start_date: Optional[datetime] = Field(default=None, description="The earliest planned start date of all activities in the EPS.", alias="SummaryPlannedStartDate")
    ...
    summary_remaining_duration: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total working time from the EPS remaining start date to the remaining finish date.", alias="SummaryRemainingDuration")
    summary_remaining_expense_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The remaining costs for all project expenses associated with the activities in the EPS.", alias="SummaryRemainingExpenseCost")
    ...
    summary_remaining_labor_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The remaining costs for all labor resources assigned to the activities. The remaining cost reflects the cost remaining for the EPS.", alias="SummaryRemainingLaborCost")
    summary_remaining_labor_units: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The remaining units for all labor resources assigned to the activities. The remaining units reflects the work remaining to be done for the EPS.", alias="SummaryRemainingLaborUnits")
    summary_remaining_material_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The remaining material costs for all project expenses associated with the activities in the EPS.", alias="SummaryRemainingMaterialCost")
    summary_remaining_non_labor_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The remaining nonlabor costs for all project expenses associated with the activities in the EPS.", alias="SummaryRemainingNonLaborCost")
    summary_remaining_non_labor_units: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The remaining units for all nonlabor resources assigned to the activities. The remaining units reflects the work remaining to be done for the EPS.", alias="SummaryRemainingNonLaborUnits")
    summary_remaining_start_date: Optional[datetime] = Field(default=None, description="The earliest remaining start of all activities assigned to the EPS.", alias="SummaryRemainingStartDate")
    summary_remaining_total_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The sum of all remaining total costs in the EPS.", alias="SummaryRemainingTotalCost")
    summary_schedule_percent_complete: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The measure that indicates how much of the EPS baseline duration has been completed so far. Computed based on where the current data date falls between the activity's baseline start and finish dates. If the data date is earlier than the Baseline start, the schedule % complete is 0. If the data date is later than the Baseline finish, the schedule % complete is 100. The schedule % complete indicates how much of the EPS duration should be currently completed, relative to the selected baseline.", alias="SummarySchedulePercentComplete")
    ...
    summary_units_percent_complete: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The percent complete of units for the resource assignments in the EPS. Computed as Actual Units / At Complete Units * 100. Always in the range 0 to 100.", alias="SummaryUnitsPercentComplete")
