...
class RoleCodeTypeExport(BaseModel):
    """
    RoleCodeType Entity
    """ # noqa: E501
    ...
    var_field: Optional[List[StrictStr]] = Field(default=None, description="List of Fields for RoleCodeType Business Object", alias="Field")
