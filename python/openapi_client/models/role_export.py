...
class RoleExport(BaseModel):
    ...
    var_field: Optional[List[StrictStr]] = Field(default=None, description="List of Fields for Role Business Object", alias="Field")
    ...
    def var_field_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['CALCULATE_COST_FROM_UNITS', 'CREATE_DATE', 'CREATE_USER', 'ID', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'NAME', 'OBJECT_ID', 'PARENT_OBJECT_ID', 'RESPONSIBILITIES', 'SEQUENCE_NUMBER']):
                raise ValueError("each list item must be one of ('CALCULATE_COST_FROM_UNITS', 'CREATE_DATE', 'CREATE_USER', 'ID', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'NAME', 'OBJECT_ID', 'PARENT_OBJECT_ID', 'RESPONSIBILITIES', 'SEQUENCE_NUMBER')")
        return value
