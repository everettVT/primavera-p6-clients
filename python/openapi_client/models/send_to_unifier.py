...
class SendToUnifier(BaseModel):
    """
    SendToUnifier Entity
    """ # noqa: E501
    project_object_id: Optional[List[StrictInt]] = Field(default=None, description="The unique identifier of the project that you want to send to Primavera Unifier.", alias="ProjectObjectId")
    ...
    __properties: ClassVar[List[str]] = ["ProjectObjectId", "Timeout"]
