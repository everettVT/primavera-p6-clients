...
class SummarizeCBS(BaseModel):
    """
    SummarizeCBS Entity
    """ # noqa: E501
    project_object_id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the project that you want to send to Primavera Unifier.", alias="ProjectObjectId")
