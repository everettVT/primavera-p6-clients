...
class ProjectDeployment(BaseModel):
    ...
    deployment_object_id: Optional[StrictInt] = Field(default=None, alias="DeploymentObjectId")
    ...
    __properties: ClassVar[List[str]] = ["DeploymentName", "DeploymentObjectId", "ObjectId", "ProjectObjectId", "ProviderName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DeploymentObjectId": obj.get("DeploymentObjectId"),
