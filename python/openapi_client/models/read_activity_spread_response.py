...
class ReadActivitySpreadResponse(BaseModel):
    """
    ...
    period: Optional[List[ActivitySpreadPeriod]] = Field(default=None, alias="Period")
    __properties: ClassVar[List[str]] = ["ActivityId", "ActivityObjectId", "StartDate", "EndDate", "PeriodType", "Period"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Period": [ActivitySpreadPeriod.from_dict(_item) for _item in obj["Period"]] if obj.get("Period") is not None else None
        })
        return _obj
