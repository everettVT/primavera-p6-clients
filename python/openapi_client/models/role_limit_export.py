...
class RoleLimitExport(BaseModel):
    """
    RoleLimit Entity
    """ # noqa: E501
    ...
    var_field: Optional[List[StrictStr]] = Field(default=None, description="List of Fields for RoleLimit Business Object", alias="Field")
    ...
    def var_field_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['CREATE_DATE', 'CREATE_USER', 'EFFECTIVE_DATE', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'MAX_UNITS_PER_TIME', 'OBJECT_ID', 'ROLE_OBJECT_ID']):
                raise ValueError("each list item must be one of ('CREATE_DATE', 'CREATE_USER', 'EFFECTIVE_DATE', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'MAX_UNITS_PER_TIME', 'OBJECT_ID', 'ROLE_OBJECT_ID')")
        return value
