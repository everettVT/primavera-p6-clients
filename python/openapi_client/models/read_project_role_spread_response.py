...
class ReadProjectRoleSpreadResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ProjectId", "ProjectObjectId", "RoleId", "RoleObjectId", "StartDate", "EndDate", "PeriodType", "Period"]
