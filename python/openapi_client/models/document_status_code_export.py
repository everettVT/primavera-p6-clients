...
class DocumentStatusCodeExport(BaseModel):
    """
    ...
    var_field: Optional[List[StrictStr]] = Field(default=None, description="List of Fields for DocumentStatusCode Business Object", alias="Field")
    ...
    def var_field_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['CREATE_DATE', 'CREATE_USER', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'NAME', 'OBJECT_ID', 'SEQUENCE_NUMBER']):
                raise ValueError("each list item must be one of ('CREATE_DATE', 'CREATE_USER', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'NAME', 'OBJECT_ID', 'SEQUENCE_NUMBER')")
        return value
