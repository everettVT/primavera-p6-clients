...
class CreateActivityRiskResponse(BaseModel):
    """
    ...
    activity_object_id: Optional[StrictInt] = Field(default=None, description="The unique ID of the activity to which the risk is assigned.", alias="ActivityObjectId")
    __properties: ClassVar[List[str]] = ["RiskObjectId", "ActivityObjectId"]
