...
class ProjectCodeTypeExport(BaseModel):
    """
    ...
    var_field: Optional[List[StrictStr]] = Field(default=None, description="List of Fields for ProjectCodeType Business Object", alias="Field")
    ...
    def var_field_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['CREATE_DATE', 'CREATE_USER', 'IS_SECURE_CODE', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'LENGTH', 'MAX_CODE_VALUE_WEIGHT', 'NAME', 'OBJECT_ID', 'SEQUENCE_NUMBER', 'WEIGHT']):
                raise ValueError("each list item must be one of ('CREATE_DATE', 'CREATE_USER', 'IS_SECURE_CODE', 'LAST_UPDATE_DATE', 'LAST_UPDATE_USER', 'LENGTH', 'MAX_CODE_VALUE_WEIGHT', 'NAME', 'OBJECT_ID', 'SEQUENCE_NUMBER', 'WEIGHT')")
        return value
