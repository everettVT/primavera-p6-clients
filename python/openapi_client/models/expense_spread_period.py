...
class ExpenseSpreadPeriod(BaseModel):
    """
    ExpenseSpreadPeriod
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["StartDate", "EndDate", "FinancialPeriodObjectId", "ActualCost", "AtCompletionCost", "PlannedCost", "RemainingCost", "CumulativeActualCost", "CumulativeAtCompletionCost", "CumulativePlannedCost", "CumulativeRemainingCost"]
